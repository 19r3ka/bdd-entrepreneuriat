...
describe('ErrorHandler', () => {
  ...
  describe('handleApiError', () => {
    ...
    it('logs to console when toast is not provided', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('Toast service not provided, showing in console:', 'API error occurred');
      expect(consoleErrorSpy).toHaveBeenCalledWith('API Error:', error);
    });
  });
  ...
  describe('handleValidationError', () => {
    ...
    it('logs to console when toast is not provided', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('Toast service not provided, showing in console:', 'Custom validation error');
    });
  });
  ...
  describe('handleGenericError', () => {
    ...
    it('defaults to "An unexpected error occurred" for unknown error types', () => {
      errorHandler.handleGenericError(123, mockToast);
    ...
    it('logs to console when toast is not provided', () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('Toast service not provided, showing in console:', 'Generic error');
