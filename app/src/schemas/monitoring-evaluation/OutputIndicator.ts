...
export const OutputIndicatorSchema = z.object({
  ...
  name: z
    ...
    .min(2)
    .max(200)
    .describe("Indicator name (e.g., 'MSMEs trained in financial literacy')"),
  description: z
    .string()
    .max(500)
    .optional()
    .describe('Detailed description of what this indicator measures'),
  category: z
    .enum([
    ...
    .optional()
    .describe('UNDP MSME Strategy category'),
