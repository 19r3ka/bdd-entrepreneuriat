...
export const QuickWinIndicatorValueSchema = z.object({
  ...
  currency: z
    ...
    .length(3)
    .optional()
    .describe('ISO 4217 currency code (when unit is currency)'),
...
export const QuickWinSchema = z
  .object({
    ...
    milestone: z.number().min(1).max(4).optional().describe('Maturity milestone level (1-4)'),
    ...
    rbmLevel: z
      .literal('output')
      .default('output')
      .describe("RBM level - always 'output' for QuickWins"),
    ...
    irrfIndicatorIds: z
      .array(z.string())
      .optional()
      .describe('IRRF indicator IDs this output contributes to'),
    ...
    evidenceIds: z
      ...
      .optional()
      .default([])
      .describe('Evidence/attachments (future feature)'),
