export const IndicatorCatalog = [
    {
        ...
        indicators: [
            { name: "Revenue growth %", unit: "percent", irrfCode: "IRRF-1.1.2", sdgTargets: ["8.3"], disagg: false },
    ...
    },
    {
        ...
        indicators: [
            { name: "Jobs created", unit: "count", genderDisagg: true, sdgTargets: ["8.5"], irrfCode: "IRRF-2.3.1", disagg: true },
    ...
    },
    {
        ...
        indicators: [
            { name: "New markets entered", unit: "count", irrfCode: "IRRF-1.2.1", sdgTargets: ["17.11"], disagg: false },
