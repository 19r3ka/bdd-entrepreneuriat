...
export const useIndicatorStore = defineStore('indicator', {
  ...
  actions: {
    // Indicator Actions
    async addIndicator(indicator: Omit<IndicatorDefinition, 'id' | 'createdAt' | 'updatedAt'>): Promise<IndicatorDefinition> {
    ...
    async updateIndicator(id: string, updates: Partial<Omit<IndicatorDefinition, 'id' | 'createdAt'>>): Promise<void> {
    ...
    // Measurement Actions
    async addMeasurement(measurement: Omit<Measurement, 'id' | 'createdAt' | 'updatedAt'>): Promise<Measurement> {
    ...
    async updateMeasurement(id: string, updates: Partial<Omit<Measurement, 'id' | 'createdAt'>>): Promise<void> {
