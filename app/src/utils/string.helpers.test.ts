...
describe('string.helpers', () => {
  ...
  describe('getRandomColorClass', () => {
    it('returns a deterministic color class based on input', () => {
      ...
      expect(color3).toMatch(/^bg-(red|green|blue|purple|teal|orange|indigo|yellow|pink|gray)-[1-9]00$/);
    });
    ...
    it('returns one of the valid color classes', () => {
      ...
      expect(color).toMatch(/^bg-(red|green|blue|purple|teal|orange|indigo|yellow|pink|gray)-[1-9]00$/);
    });
  });
});