...
const columns = computed(() => [
  { field: 'title', header: t('pages.support.title'), sortable: true, dataType: 'text' as const },
  { field: 'businessId', header: t('business.label'), sortable: true, dataType: 'text' as const },
  {
    field: 'boostType',
    header: t('pages.support.boostType'),
    sortable: true,
    dataType: 'text' as const,
  },
  {
    field: 'modality',
    header: t('pages.support.modality'),
    sortable: true,
    dataType: 'text' as const,
  },
  {
    field: 'startDate',
    header: t('pages.support.startDate'),
    sortable: true,
    dataType: 'date' as const,
  },
  {
    field: 'endDate',
    header: t('pages.support.endDate'),
    sortable: true,
    dataType: 'date' as const,
  },
  { field: 'provider', header: t('common.provider'), sortable: true, dataType: 'text' as const },
  { field: 'quantity', header: t('pages.support.quantityValue'), sortable: false },
]);
