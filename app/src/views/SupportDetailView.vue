  ...
  <div class="surface-ground min-h-screen p-4 md:p-6">
    ...
    <div v-else-if="support" class="max-w-5xl mx-auto">
      ...
      <div class="card mb-4">
        ...
        <div class="grid mb-4">
          ...
          <div class="col-12 md:col-6">
            <div class="p-3 surface-100 border-round h-full">
              ...
              <div class="flex align-items-center gap-2">
                <i class="pi pi-calendar text-primary"></i>
                <span class="text-xl font-medium">{{ support.endDate ? formatDate(support.endDate) : $t('common.notSpecified') }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 md:col-6">
            <div class="p-3 surface-100 border-round h-full">
              ...
              <div class="flex align-items-center gap-2">
                ...
                <span class="text-xl font-medium">{{ support.provider || $t('common.notSpecified') }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 md:col-6">
            <div class="p-3 surface-100 border-round h-full">
              ...
              <div class="flex align-items-center gap-2">
                ...
                <span class="text-xl font-medium">{{ support.channel || $t('common.notSpecified') }}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- Quantity/Value -->
        <div v-if="support.quantity && (support.quantity.value || support.quantity.unit)" class="mb-4">
