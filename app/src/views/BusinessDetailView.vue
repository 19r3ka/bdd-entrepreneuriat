...
import { BUSINESS_ACTIONS } from '@/constants/actions';
          ...
          <TabList>
            <Tab :value="BUSINESS_TABS.OVERVIEW">
              <div class="flex align-items-center gap-2">
                ...
                <span class="font-semibold">{{
                  $t('pages.dashboard.businessDetail.tabs.overview')
                }}</span>
              </div>
            </Tab>
            <Tab :value="BUSINESS_TABS.REPORTS">
              <div class="flex align-items-center gap-2">
                ...
                <span class="font-semibold">{{
                  $t('pages.dashboard.businessDetail.tabs.reports')
                }}</span>
              </div>
            </Tab>
            <Tab :value="BUSINESS_TABS.SUPPORTS">
              <div class="flex align-items-center gap-2">
                ...
                <span class="font-semibold">{{
                  $t('pages.dashboard.businessDetail.tabs.supports')
                }}</span>
              </div>
            </Tab>
            <Tab :value="BUSINESS_TABS.QUICK_WINS">
              <div class="flex align-items-center gap-2">
                ...
                <span class="font-semibold">{{
                  $t('pages.dashboard.businessDetail.tabs.quickWins')
                }}</span>
              </div>
            </Tab>
            <Tab :value="BUSINESS_TABS.OUTCOMES">
              <div class="flex align-items-center gap-2">
                ...
                <span class="font-semibold">{{
                  $t('pages.dashboard.businessDetail.tabs.outcomes')
                }}</span>
              </div>
            </Tab>
          </TabList>
            ...
            <TabPanel :value="BUSINESS_TABS.QUICK_WINS">
              ...
              >
                <template #append-actions="{ data }">
                  <Button
                    v-tooltip.top="
                      $t('pages.dashboard.businessDetail.actions.addPerformanceReport')
                    "
                    icon="pi pi-chart-line"
