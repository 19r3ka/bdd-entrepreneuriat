    ...
    <div class="flex-1">
      <div class="flex justify-content-between align-items-start">
        ...
        <span 
          ...
          :class="{
            'bg-red-100 text-red-800 dark:bg-red-500/30 dark:text-red-100': action.priority === 'high',
            'bg-orange-100 text-orange-800 dark:bg-orange-500/30 dark:text-orange-100': action.priority === 'medium',
            'bg-green-100 text-green-800 dark:bg-green-500/30 dark:text-green-100': action.priority === 'low'
          }"
        >
          {{ action.priority }}
        </span>
