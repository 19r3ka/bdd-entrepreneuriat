    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            >
                ...
                <template #trend>
                    <span v-if="staffGrowth.trend !== 0" class="flex align-items-center gap-1 text-sm font-bold" :class="staffGrowth.direction === 'up' ? 'text-green-600' : 'text-red-600'">
                        <i :class="staffGrowth.direction === 'up' ? 'pi pi-arrow-up' : 'pi pi-arrow-down'" class="text-xs"></i>
            ...
            >
                ...
                <template #trend>
                    <span v-if="marketMetric.trend !== null && marketMetric.trend !== 0" class="flex align-items-center gap-1 text-sm font-bold" :class="marketMetric.trendDirection === 'up' ? 'text-green-600' : 'text-red-600'">
                        <i :class="marketMetric.trendDirection === 'up' ? 'pi pi-arrow-up' : 'pi pi-arrow-down'" class="text-xs"></i>
            ...
            >
                ...
                <template #trend>
                    <span v-if="revenueMetric.trend !== null && revenueMetric.trend !== 0" class="flex align-items-center gap-1 text-sm font-bold" :class="revenueMetric.trendDirection === 'up' ? 'text-green-600' : 'text-red-600'">
                        <i :class="revenueMetric.trendDirection === 'up' ? 'pi pi-arrow-up' : 'pi pi-arrow-down'" class="text-xs"></i>
            ...
            >
                ...
                <template #trend>
                    <span v-if="profitMetric.trend !== null && profitMetric.trend !== 0" class="flex align-items-center gap-1 text-sm font-bold" :class="profitMetric.trendDirection === 'up' ? 'text-green-600' : 'text-red-600'">
                        <i :class="profitMetric.trendDirection === 'up' ? 'pi pi-arrow-up' : 'pi pi-arrow-down'" class="text-xs"></i>
