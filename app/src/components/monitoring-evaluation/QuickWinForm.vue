              ...
              <div v-if="isBooleanUnit(item.indicatorId)" class="formgrid grid">
                <div class="field col-12">
                  ...
                  <SelectButton
                    ...
                    optionLabel="label"
                    optionValue="value"
                    @change="() => updateIndicatorValue(index, 'currentValue', item.currentValue, values.indicatorValues, setFieldValue)"
                  />
                </div>
                <div class="field col-12">
                  ...
                  <InputText
                    ...
                    @input="(e) => updateIndicatorValue(index, 'notes', (e.target as HTMLInputElement)?.value, values.indicatorValues, setFieldValue)"
                    class="w-full"
                  />
                </div>
              </div>
              ...
              <div v-else class="formgrid grid">
                <div class="field col-12 md:col-4">
                  ...
                  <InputNumber
                    ...
                    @input="(e) => updateIndicatorValue(index, 'baseline', e.value, values.indicatorValues, setFieldValue)"
                    :minFractionDigits="0"
                    :maxFractionDigits="2"
                    class="w-full"
                  />
                  <InputText
                    v-else
                    v-model="item.baseline"
                    @input="(e) => updateIndicatorValue(index, 'baseline', (e.target as HTMLInputElement)?.value, values.indicatorValues, setFieldValue)"
                    class="w-full"
                  />
                </div>
                <div class="field col-12 md:col-4">
                  ...
                  <InputNumber
                    v-if="isNumericUnit(item.indicatorId)"
                    v-model="item.target"
                    @input="(e) => updateIndicatorValue(index, 'target', e.value, values.indicatorValues, setFieldValue)"
                    :minFractionDigits="0"
                    :maxFractionDigits="2"
                    class="w-full"
                  />
                  <InputText
                    v-else
                    v-model="item.target"
                    @input="(e) => updateIndicatorValue(index, 'target', (e.target as HTMLInputElement)?.value, values.indicatorValues, setFieldValue)"
                    class="w-full"
                  />
                </div>
                <div class="field col-12 md:col-4">
                  ...
                  <InputNumber
                    v-if="isNumericUnit(item.indicatorId)"
                    v-model="item.currentValue"
                    @input="(e) => updateIndicatorValue(index, 'currentValue', e.value, values.indicatorValues, setFieldValue)"
                    :minFractionDigits="0"
                    :maxFractionDigits="2"
                    class="w-full"
                  />
                  <InputText
                    v-else
                    v-model="item.currentValue"
                    @input="(e) => updateIndicatorValue(index, 'currentValue', (e.target as HTMLInputElement)?.value, values.indicatorValues, setFieldValue)"
                    class="w-full"
                  />
                </div>
                <div class="field col-12">
...
const searchTags = (event: { query: string }) => {
  filteredTags.value = tags.value.filter(tag => tag.toLowerCase().includes(event.query.toLowerCase()));
};

// Indicators Logic
const addIndicator = (indicator: OutputIndicator, currentList: QuickWinIndicatorValue[], setFieldValue: any) => {
...
const removeIndicator = (index: number, currentList: QuickWinIndicatorValue[], setFieldValue: any) => {
