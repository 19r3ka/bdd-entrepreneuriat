...
interface Props<T> {
  ...
  label: string;
  modelValue: Ref<T> | T;
  error?: Ref<ErrorObj | null | undefined> | ErrorObj | null | undefined;
  onBlur?: (event?: FocusEvent) => void;
  type?: 'text' | 'email' | 'number' | 'password' | 'textarea' | 'select' | 'date' | 'selectbutton';
 ...
 *
 */
function updateModelValue(newValue: unknown) {
