...
function D(t2, e, o = true) {
  ...
  if (t2) {
    ...
    f2.top + u + s4 > lt.height ? (L = f2.top + g2 - s4, ot = "bottom", L < 0 && (L = g2)) : L = u + f2.top + g2, f2.left + a2 > lt.width ? N2 = Math.max(0, f2.left + it + c - a2) : N2 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N2 + "px" : t2.style.insetInlineStart = N2 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l2 = (i2 = x(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l2 : "");
  }
}
function S(t2, e) {
...
function I(t2, e, o = true, n = void 0) {
  var r;
  if (t2) {
    let i2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), l2 = e.offsetHeight, d = e.getBoundingClientRect(), s4 = h(), a2, u, c = n != null ? n : "top";
    if (!n && d.top + l2 + i2.height > s4.height ? (a2 = -1 * i2.height, c = "bottom", d.top + a2 < 0 && (a2 = -1 * d.top)) : a2 = l2, i2.width > s4.width ? u = d.left * -1 : d.left + i2.width > s4.width ? u = (d.left + i2.width - s4.width) * -1 : u = 0, t2.style.top = a2 + "px", t2.style.insetInlineStart = u + "px", t2.style.transformOrigin = c, o) {
...
function zt(t2, e) {
  var o, n;
  if (t2) {
    let r = t2.parentElement, i2 = K(r), l2 = h(), d = t2.offsetParent ? t2.offsetWidth : J(t2), s4 = t2.offsetParent ? t2.offsetHeight : G2(t2), a2 = v((o = r == null ? void 0 : r.children) == null ? void 0 : o[0]), u = C((n = r == null ? void 0 : r.children) == null ? void 0 : n[0]), c = "", f2 = "";
    i2.left + a2 + d > l2.width - O() ? i2.left < d ? e % 2 === 1 ? c = i2.left ? "-" + i2.left + "px" : "100%" : e % 2 === 0 && (c = l2.width - d - O() + "px") : c = "-100%" : c = "100%", t2.getBoundingClientRect().top + u + s4 > l2.height ? f2 = `-${s4 - u}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = c;
  }
}
function _t(t2, e = "", o) {
  ...
  if (a(e)) {
    ...
    if (G(a2, k2)) {
      let n = a2.replaceAll(k2, (l2) => {
        let c = l2.replace(/{|}/g, "").split(".").filter((m2) => !s4.some((d) => G(m2, d)));
...
function le(e, t2) {
  ...
  function r(n, l2) {
    ...
    for (; c <= n.length; ) {
      let g2 = n[c];
      if ((g2 === '"' || g2 === "'" || g2 === "`") && n[c - 1] !== "\\" && (d = d === g2 ? null : g2), !d && (g2 === "(" && u++, g2 === ")" && u--, (g2 === "," || c === n.length) && u === 0)) {
        let f2 = m2.trim();
  ...
  for (let n = i2.length - 1; n >= 0; n--) {
    let [l2, o] = i2[n], c = e.slice(l2 + 3, o), m2 = r(c, t2), d = t2(...m2);
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g2 = m2[u], f2 = ve(g2), p2 = G(u, a2) ? Q2(d) : Q2(d, re(u));
      if (i(f2)) o.push({ node: f2, path: p2 });
      else {
        let y2 = ae(p2), R2 = Y3(f2, p2, s4, [a2]);
        Re(l2, y2, R2);
        let T2 = p2;
  ...
  let c = l2.join("");
  return { value: l2, tokens: n, declarations: c, css: C3(i2, c) };
}
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  return { primitive: { css: l2, tokens: o }, semantic: { css: c, tokens: m2 }, global: { css: d, tokens: u }, style: g2 };
}, getPreset({ name: e = "", preset: t2 = {}, options: r, params: s4, set: i2, defaults: a2, selector: n }) {
  var f2, x3, p2;
  let l2, o, c;
  if (s(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j2 } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d = T2 || {}, { colorScheme: M2 } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), g2 = M2 || {}, { dark: te } = g2, re2 = v2(g2, ["dark"]), K2 = s(O2) ? this._toVariables({ [y2]: h2(h2({}, O2), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: h2(h2({}, L), re2) }, r) : {}, X = s(V2) ? this._toVariables({ [y2]: h2(h2({}, V2), te) }, r) : {}, [G3, U2] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H3, W2] = [(p2 = X.declarations) != null ? p2 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G3}${B2}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H3, "dark", "variable", r, i2, a2, n);
    l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U2, ...I2, ...W2])], c = m(j2, { dt: E2 });
  }
  ...
  var c;
  let n = { name: e, theme: t2, params: r, set: i2, defaults: a2 }, l2 = (c = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c.css, o = Object.entries(s4).reduce((m2, [d, u]) => m2.push(`${d}="${u}"`) && m2, []).join(" ");
  ...
  let a2 = function(l2, o = {}, c = []) {
    ...
    Object.entries(l2).forEach(([m2, d]) => {
      let u = G(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe(m2)}` : oe(m2), g2 = c ? `${c}.${m2}` : m2;
      i(d) ? n(d, u, g2) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x3 = {}, p2 = []) => {
  ...
  if (s(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c.reduce((m2, { type: d, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d, t2)), m2), "") : C3(l2 != null ? l2 : ":root,:host", t2);
    }
    if (o) {
      let c = { name: "primeui", order: "primeui" };
      i(o) && (c.name = m(o.name, { name: e, type: s4 })), s(c.name) && (t2 = C3(`@layer ${c.name}`, t2), a2 == null || a2.layerNames(c.name));
    }
    return t2;
  }
  return "";
...
//# sourceMappingURL=chunk-RIJ7I7L2.js.map
