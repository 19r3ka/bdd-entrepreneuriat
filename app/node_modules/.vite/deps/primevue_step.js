...
var script2 = {
  ...
  mounted: function mounted() {
    if (this.$el && this.$pcStepList) {
      var index = h(this.$el, Y(this.$pcStepper.$el, '[data-pc-name="step"]'));
      var activeIndex = h(z(this.$pcStepper.$el, '[data-pc-name="step"][data-p-active="true"]'), Y(this.$pcStepper.$el, '[data-pc-name="step"]'));
      var stepLen = Y(this.$pcStepper.$el, '[data-pc-name="step"]').length;
...
//# sourceMappingURL=primevue_step.js.map
